...
?>
        <form id="actor-form" method="POST" enctype="multipart/form-data" class="w-10/12 mx-auto text-black flex flex-col h-[500px] overflow-y-hidden items-center space-y-4 p-10">
            ...
            <div>
                ...
                <input required type="file" class="block w-full px-4 py-2 mt-2 bg-white border rounded-md focus:border-secondary focus:ring-secondary focus:outline-none focus:ring focus:ring-opacity-40 mb-4" id="ActorImage" name="image" accept="image/png, image/gif, image/jpeg">
                <div id="preview-container" class="flex justify-center rounded-md">
                    <img id="preview-image" src="" class="ActorImg object-cover max-h-[500px] max-w-[600px]">
                </div>
            </div>
